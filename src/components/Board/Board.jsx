...
import DropdownStyles from "../Board/Dropdown.module.css"
...
export default function Board () {
  ...
  const handleEdgeOptions = (_event,option) => {
    ...
    setOptions(updatedOptions);
    setSelectedAlgo({ key: "select", text: "Select Algorithme" });
  ...
  const handleAlgoOptions = (_event,option) => {
    ...
    setSelectedEdge({ key: "select", text: "Select arete" });
      ...
      <div className={styles.board}>
        ...
        >
          ...
          {/* <div className={styles.miscellaneous}> */}
            <button
              // className={`${styles.optionButtons} ${
              //   options.pause && styles.selectedButtonOption
              // }`}
              className={`${styles.optionButtons} ${
                 styles.selectedButtonOption
              }`}
              onClick={() => activateOption("pause")}
              //disabled={isVisualizing}
            >
              <i className={`${styles.icon} fas fa-undo-alt`}></i>
              Pause
          ...
          {/* <div className={styles.miscellaneous}> */}
            <button
              ...
              onClick={() => activateOption("continue")}
              //disabled={isVisualizing}
            >
              <i className={`${styles.icon} fas fa-undo-alt`}></i>
              Continue
